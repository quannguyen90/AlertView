...
// AlertView
#define COCOAPODS_POD_AVAILABLE_AlertView
#define COCOAPODS_VERSION_MAJOR_AlertView 0
#define COCOAPODS_VERSION_MINOR_AlertView 1
#define COCOAPODS_VERSION_PATCH_AlertView 0
